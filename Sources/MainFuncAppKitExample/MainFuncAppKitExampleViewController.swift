//
//  MainFuncAppKitExampleViewController.swift
//  SwiftWindowLauncher
//
...
final class MainFuncAppKitViewController: NSTabViewController {
...
final class HomePaneViewController: NSViewController {
    override func loadView() {
        let label = NSTextField(labelWithString: "Hello, SwiftGUILauncher!")
